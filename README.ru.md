...
2. API доступен B2B-клиентам — свяжитесь с [отделом продаж](https://mymeet.ai/contact), чтобы получить API-ключ.
3. Изучайте и пробуйте запросы в интерактивном справочнике: https://backend.mymeet.ai/docs/
